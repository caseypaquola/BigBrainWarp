...
**1) `BigBrainSym <https://bigbrainwarp.readthedocs.io/en/latest/pages/FAQs.html>`_ ** involved co-registration of BigBrain to a population-averaged T1 map in ICBM152 space using with the SyN algorithm (`Avants et al., 2008 <https://doi.org/10.1016/j.media.2007.06.004>`_). 
