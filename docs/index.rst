...
BigBrain is singular dataset that offers a volumetric reconstruction of high-resolution cell-stained slices of a post mortem human brain. 
|BigBrainWarp provides approaches to transform from histological to MNI152 space to help a wide range of neuroscientistists utilise the cytoarchitectural information encoded in BigBrain. We aim to provide:
