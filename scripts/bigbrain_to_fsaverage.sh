...
for hemi in L R ; do
	...
	if [[ "$extension" == *"gii"* ]] ; then
		...
		gii_type=label
		python "$bbwDir"/scripts/annot2gii.py "$inData" "$wd"/tpl-bigbrain_hemi-"$hemi"_desc-"$desc"."$gii_type".gii "$bbwDir"/spaces/tpl-bigbrain/tpl-bigbrain_hemi-"$hemi"_desc-aparc."$gii_type".gii
		...
		if [[  "$interp" == "nearest" ]] ; then
			gii_type=label
			python "$bbwDir"/scripts/txt2gii.py "$inData" "$wd"/tpl-bigbrain_hemi-"$hemi"_desc-"$desc"."$gii_type".gii "$bbwDir"/spaces/tpl-bigbrain/tpl-bigbrain_hemi-"$hemi"_desc-aparc."$gii_type".gii
		else
			gii_type=shape
